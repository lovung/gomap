...
func TestThreadSafeSortedSliceMap(t *testing.T) {
	// Create a new threadSafeSortedSliceMap instance
	m := NewThreadSafeSortedSliceMap[int, string]()
...
func TestThreadSafeSortedSliceMap_Empty(t *testing.T) {
	// Create an empty threadSafeSortedSliceMap
	m := NewThreadSafeSortedSliceMap[int, string]()
